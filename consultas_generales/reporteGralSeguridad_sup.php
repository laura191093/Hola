...
LEFT JOIN select_3 e ON e.id = d.select3 WHERE supervisor= '%s' ORDER BY id DESC", $colname_RecordsetTable);
...
LEFT JOIN select_3 e ON e.id = r.select3 WHERE r.supervisor_de_seguridad = '%s'", $colname_RecordsetTable);
...
<form id="form2" name="form2" method="post" action="descargarReporteGral_sup.php">
  <label></label>
...
<br />
<form id="form1" name="form1" method="post" action="reporteGralSeguridad_sup.php">
  <label></label>
...
<div id="div_Asaltos" style="display: none;">
    ...
    <td><?php echo $row_Asaltos['semana']; ?></td>
        ...
        <td><?php echo $row_Asaltos['narracion']; ?></td>X
