...
//Reporte para excel
		mysql_select_db($database_conexion_usuarios, $conexion_usuarios);
		$query_Tecnicos = sprintf("SELECT * FROM tecnicos_seguridad  WHERE supervisor = '%s' AND estatus= 'SEGUIMIENTO'",  $colname_Recordset1);
		...
		$fecha01="Actividades Tecnicos en Seguimiento(Descargado) ".$f.".xlsx";
			...
			<div id="contenidocab" class="col8 ">
              <table width="623" border="0" cellpadding="0" cellspacing="0" style="width: 780px;">
                <tbody>
                  <tr>
                    <td>
					<h1>DESCARGAR ACTIVIDADES EN SEGUIMIENTO</h1>
                     </td>
                  </tr>
                </tbody>
              </table>
