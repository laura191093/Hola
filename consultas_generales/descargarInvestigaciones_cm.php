...
//Reporte para excel
		mysql_select_db($database_conexion_usuarios, $conexion_usuarios);
		$query_Investigaciones = "SELECT *, CONCAT(con_marca, '/', con_region, '/', con_asunto, '/', con_ceve , '', con_fecha, '', con_sup)  As codigo FROM investigaciones";
...
<form id="form3" name="form3" class= "reporte" method="post" action="descargarInvestigaciones_cm.php">
<strong>EXPORTAR INVESTIGACIONES </strong>
    <img src="../imagenes/export_to_excel.gif" alt="excel" class="botonExcel" />

    <input type="submit" name="Descargar" id="Descargar" class="button themed" value="DESCARGAR"/>
</form>
</body>
</html>