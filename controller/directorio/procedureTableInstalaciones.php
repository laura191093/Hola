...
<table width="103%"  border="0" align="center">
 ...
 <tr>
	...
	<td width="113"><div align="center">
      ...
      <td><div align="center"><a href="actualiza_directorioInstalaciones.php?recordID=<?php echo $row_directorio['id']; ?>"><img src="imagenes/edit.png" title="ACTUALIZAR INFORMACION" width="30" height="30" border="0"></a></div></td>
      <td><div align="center"><a href="b_instalacion.php?recordID=<?php echo $row_directorio['id']; ?>"><img src="imagenes/borrar.png" title="BORRAR REGISTRO" width="25" height="25" border="0"></a></div></td>
 <td width="135" bordercolor="#333333"><div align="center"><strong><?php echo utf8_encode($row_directorio['region']); ?></strong></div></td>
      ...
      <td width="113"><div align="center"><strong><?php echo "<a href='mailto:".$row_directorio['administrador']."'>".$row_directorio['administrador']."</a>" ?></strong></div></td>
        ...
        <td colspan="10"><a href="https://www.google.com.mx/maps/place/<?php echo $row_directorio['latitud']; ?> <?php echo $row_directorio['longitud']; ?>" target="_blank"><span class="Estilo2">VER EL GOOGLE MAPS</span> https://www.google.com.mx/maps/place/<?php echo $row_directorio['latitud']; ?> <?php echo $row_directorio['longitud']; ?></a></td>
      </tr>
   </table>
