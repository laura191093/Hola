...
//include('../../connections/conexion_usuarios.php');

$recordID = $_GET['recordID'];

$consulta = "SELECT * FROM asaltos where id =  '$recordID'";
$query = mysql_query($consulta);
$row = mysql_fetch_array($query);
		
date_default_timezone_set('America/Mexico_City');
$fecha=date("d-m-y H.i");
$folio='A'.$recordID.$row['turno'].' '.$fecha.'.pdf';
...
$consulta = "SELECT * FROM robo_equipo where id =  '$recordID'";
$query = mysql_query($consulta);
$row = mysql_fetch_array($query);
		
date_default_timezone_set('America/Mexico_City');
$fecha=date("d-m-y H.i");
$folio='E'.$recordID.$row['turno'].' '.$fecha.'.pdf';
